...
const PostForms = ({ post, action }: PostFormProps) => {
    ...
    async function onSubmit(values: z.infer<typeof PostValiation>) {
        if (post && action === 'Update') {
            const updatedPost = await updatePost({
                ...values,
                postId: post?.$id,
                imageId: post?.ImageDownIcon,
        ...
        <Form {...form}>
            ...
            >
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className="shad-form_label ">Add Tags (seprate it by comma " , ")</FormLabel>
                            <FormControl>
                                <Input type="text" className="shad-input"
                                    placeholder="Java, Javascript, React" {...field} />
                            </FormControl>
                            <FormMessage className="shad-form_message" />
                        </FormItem>
                    )}
